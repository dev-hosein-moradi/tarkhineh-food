...
const Navbar = () => {
  ...
  return (
    <div className="font-estedad flex flex-row-reverse items-center justify-between py-[16px] px-[20px] relative max-w-[1024px] mx-auto">
      {/* navbar container */}
      <button
        onClick={() => setMenuSwitcher(!menuSwitcher)}
      ...
      <div className="flex">
        ...
        <button className="p-1 bg-[#e5f2e9] rounded-[4px] md:p-2 hidden lg:flex">
      ...
      <ul
        ...
        } min-h-[90vh] max-h-[90vh] flex flex-col text-right px-[20px] py-[16px] bg-white absolute top-14 left-0 z-10 duration-300 ease-out overflow-y-auto md:hidden`}
      >
        ...
        >
          <p
            onClick={() => {
              return setAgencySwitcher(!agencySwitcher), setListSwitcher(false);
            }}
